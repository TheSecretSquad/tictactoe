...
import com.disalvo.peter.tictactoe.gameimplementation.TicTacToe;
...
public class TicTacToeTest
{
    ...
    private Game aStartedGame() {
        startGame();
        return subject;
    }

    private Game anUnstartedGame() {
        return subject;
    }

    private Game aStoppedGame() {
    ...
    private void playToStalemate() {
        aStartedGame()
                .play(Mark.X, new Position(2, 2))
                .play(Mark.O, new Position(3, 3))
                .play(Mark.X, new Position(2, 3))
                .play(Mark.O, new Position(2, 1))
                .play(Mark.X, new Position(1, 2))
                .play(Mark.O, new Position(3, 2))
                .play(Mark.X, new Position(3, 1))
                .play(Mark.O, new Position(1, 3))
                .play(Mark.X, new Position(1, 1));
    }
    ...
    public void cannotPlayAnOccupiedPosition() {
        aStartedGame()
                .play(Mark.X, new Position(1, 1))
                .play(Mark.O, new Position(1, 1))
                .play(Mark.O, new Position(1, 1));

        verify(gameListener, times(2)).invalidPositionByMark(subject, new Position(1, 1), Mark.O);
    }
    ...
    public void fillingLeftColumnWithSameMarkWinsGame() {
        aStartedGame()
                .play(Mark.X, new Position(1, 1))
                .play(Mark.O, new Position(1, 2))
                .play(Mark.X, new Position(2, 1))
                .play(Mark.O, new Position(2, 2))
                .play(Mark.X, new Position(3, 1));
